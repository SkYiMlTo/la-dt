...
setup(
    ...
    author_email="hugo.bourreau@example.com",
    description="Look-Ahead Digital Twin: Proactive Byzantine Attack Attribution in IoT-CPS",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/yourusername/ladt-digital-twin",
    project_urls={
        "Documentation": "https://github.com/yourusername/ladt-digital-twin/wiki",
        "Bug Tracker": "https://github.com/yourusername/ladt-digital-twin/issues",
